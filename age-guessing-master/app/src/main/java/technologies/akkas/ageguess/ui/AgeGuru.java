...
public class AgeGuru {
	...
	public  void main (String args []){
		...
		value1 = value - 3; //changed value1 - 4 to value1 - 3
		
		int value2 = value + 3; //changed value2 + 4 to value2 + 3
...
public static int[] expectedBirth(int month, int day, int year)
   {
	  ...
	  int value1 = value - 3; //changed value1 - 4 to value1 - 3
	  int value2 = value + 3; //changed value2 + 4 to value2 + 3
   ...
   // check upward direction
	  ...
	  int valueUp1 = valueUp - 3; //changed valueUp - 4 to valueUp - 3
	  int valueUp2 = valueUp + 3; //changed valueUp + 4 to valueUp + 3
...
public static ArrayList<Integer> possibleAge(int month, int day, int year) 
   {
	   ...
	   int start = 0;
	   int end = 0;
	   int startYear = year - 3; //changed year - 4 to year - 3
	   int endYear = year + 3;   //changed year + 4 to year + 3
	   int end2 = 0;
	   int end3 = 0;
	   int pMonth = month;
	   int pDay = day;
	   ...
	   { 
		...
		//changed guessingAge >= ageYear - 4 && guessingAge <= ageYear + 4 
		//to guessingAge >= ageYear - 3 && guessingAge <= ageYear + 3 

		if (guessingAge >= ageYear - 3 && guessingAge <= ageYear + 3) {
